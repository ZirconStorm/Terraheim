...
{
    class SE_ThornsFire : StatusEffect
    {
        ...
        {
            m_name = "Fire Thorns";
            base.name = "Fire Thorns";
            m_tooltip = "Reflect " + (m_bonus*100) + "% of incoming damage back at your attacker as fire and lightning damage.";
            m_icon = null;
        }

        public void SetIcon()
        {
            m_icon = PrefabManager.Cache.GetPrefab<ItemDrop>("ArmorMistlandsHelmet").m_itemData.GetIcon();
        }
        ...
        public override void OnDamaged(HitData hit, Character attacker)
        {
            if (!m_character.IsBlocking() && attacker != null && attacker.m_seman != null)
            {
                ...
                reflectedDamage.m_damage.m_fire += elementDamage;
                reflectedDamage.m_damage.m_frost = 0;
                reflectedDamage.m_damage.m_lightning += elementDamage;
                ...
                reflectedDamage.m_damage.m_spirit = 0;
