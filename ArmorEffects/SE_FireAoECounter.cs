...
{
    class SE_FireAoECounter : StatusEffect
    {
        ...
        public void Awake()
        {
            ...
            m_tooltip = "Hitting an enemy " + m_activationCount + " times charges you. The next bowshot or special attack with daggers and spears will deal " 
                + m_damageBonus * 100 + "% of damage dealt as fire/lightning damage in a " + m_aoeSize + "m radius.";
        }

        public void IncreaseCounter()
        {
            if (m_character.GetSEMan().HaveStatusEffect("Flame Exhausted"))
                return;
            ...
            if(m_count >= m_activationCount && !m_character.GetSEMan().HaveStatusEffect("FirestormFX"))
            {
                Log.LogInfo("Adding status");
                m_character.GetSEMan().AddStatusEffect("FirestormFX");
        ...
        public void ClearCounter()
        {
            ...
            if(m_count < m_activationCount && m_character.GetSEMan().HaveStatusEffect("FirestormFX"))
            {
                ...
                m_character.GetSEMan().AddStatusEffect("Flame Exhausted");
            }
