...
{
    public class SE_BowMarkedForDeath : StatusEffect
    {
        ...
        public void Awake()
        {
            m_name = "Bow Marked For Death";
            base.name = "Bow Marked For Death";
            m_tooltip = "o fug";
            m_icon = null;
        }
        ...
        {
            m_count++;
            if(m_count >= m_activationCount && !m_character.GetSEMan().HaveStatusEffect("Bow Marked For Death FX"))
            {
                m_character.GetSEMan().AddStatusEffect("Bow Marked For Death FX");
        ...
        public void DecreaseHitsRemaining()
        {
            ...
            {
                ClearCounter();
                if (m_character.GetSEMan().HaveStatusEffect("Bow Marked For Death FX"))
                    m_character.GetSEMan().RemoveStatusEffect("Bow Marked For Death FX");
            }
        }
